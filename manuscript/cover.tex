...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \vspace{0.8cm}
    \textbf{\fontsize{18pt}{22pt}\selectfont \reporttitle}\\[0.25cm]

    \vspace{0.8cm}
    {\fontsize{12pt}{0pt}\selectfont Nhóm: \groupname}\\[6pt]
    {\fontsize{12pt}{0pt}\selectfont Đề tài: \projecttopic}\\[6pt]
